...
resource "azurerm_network_security_group" "myterraformnsg" {
    ...
    security_rule {
        name                       = "${var.nsg_security_rule_http["name"]}"
        priority                   = "${var.nsg_security_rule_http["priority"]}"
        direction                  = "${var.nsg_security_rule_http["direction"]}"
        access                     = "${var.nsg_security_rule_http["access"]}"
        protocol                   = "${var.nsg_security_rule_http["protocol"]}"
        source_port_range          = "${var.nsg_security_rule_http["source_port_range"]}"
