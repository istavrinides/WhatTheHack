...
SELECT
	...
	, [FRENCHPRODUCTNAME] + ' - CONG�DI� - ' + CASE WHEN [ENDDATE] IS NULL THEN CONVERT(CHAR(8),DATEADD(MONTH,@STEPD,[STARTDATE]),112) ELSE CONVERT(CHAR(8),[ENDDATE],112) END [FRENCHPRODUCTNAME]
	, [STANDARDCOST]
	, [FINISHEDGOODSFLAG]
	, [COLOR]
	, [SAFETYSTOCKLEVEL]
...
BEGIN
	...
	, [FRENCHPRODUCTNAME] + ' - CONG�DI� - ' + CONVERT(CHAR(8),DATEADD(MONTH, (@STEPD) * @I, DATEADD(MONTH, @STEPD, STARTDATE)),112)--+ CASE WHEN [ENDDATE] IS NULL THEN CONVERT(CHAR(8),DATEADD(MONTH,6,[STARTDATE]),112) ELSE CONVERT(CHAR(8),[ENDDATE],112) END [FRENCHPRODUCTNAME]
	, [STANDARDCOST]
	, [FINISHEDGOODSFLAG]
	, [COLOR]
	, [SAFETYSTOCKLEVEL]
