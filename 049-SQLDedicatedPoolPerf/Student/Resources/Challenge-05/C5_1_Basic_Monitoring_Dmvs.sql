/****************************************************************************************
--How to identify TOP 10 slowest query and their slowest step
--Identify all errors occurred in the last 8 hours
--Identify Tables size and Skewness
...
https://docs.microsoft.com/en-us/sql/relational-databases/system-dynamic-management-views/sys-dm-exec-sessions-transact-sql?view=aps-pdw-2016-au7
...
https://docs.microsoft.com/en-us/azure/synapse-analytics/sql/reference-tsql-system-views
...
SELECT * FROM sys.dm_pdw_errors ORDER BY create_time DESC
GO
...
INNER JOIN sys.dm_pdw_nodes pn
    ON  nt.[pdw_node_id] = pn.[pdw_node_id] and pn.type = 'COMPUTE'
