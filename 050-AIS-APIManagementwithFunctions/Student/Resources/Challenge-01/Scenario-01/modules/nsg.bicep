@description('The name of the NSG for API Management')
param apim_nsg_name string
...
resource apimNSGResource 'Microsoft.Network/networkSecurityGroups@2020-06-01' = {
  name: apim_nsg_name
  location: location
  properties: {
    securityRules: [
