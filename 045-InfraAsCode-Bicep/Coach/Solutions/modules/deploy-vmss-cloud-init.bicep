...
param resourcePrefix string = 'p20'
...
@description('cloud-init script body.')
...
// var scriptUrlInstallApache = 'https://raw.githubusercontent.com/albertwo1978/training-events/master/p20-arm/scripts/install_apache_vmss.sh'
  ...
  properties: {
    ...
    virtualMachineProfile: {
      ...
      osProfile: {
        ...
        customData: cloudInitScript != '' ? base64(cloudInitScript) : ''
      }
      networkProfile: {
